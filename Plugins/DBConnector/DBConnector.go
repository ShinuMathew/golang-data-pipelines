...
func createConnectionString(fileName string) string {
	...
	// json.Unmarshal(byteValue, &db_con)
...
func Open_DBConnection(fileName string) *sql.DB {

	con_string := createConnectionString(fileName)
