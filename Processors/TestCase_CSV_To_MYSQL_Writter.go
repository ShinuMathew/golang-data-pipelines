package TestCase_CSV_To_MYSQL_Writter
...
import (
	...
	"github.com/Shinz9474/InsightAps/DataProcessor/Logger"
	"github.com/Shinz9474/InsightAps/DataProcessor/Plugins/CSVHandler"
	"github.com/Shinz9474/InsightAps/DataProcessor/Plugins/DBConnector"
)
...
func Start_Processor(tc_name string) {
	...
	fileName := "ProcessorConfigs/TestCase_CSV_To_MYSQL_Writter.json"
	...
	db := DBConnector.Open_DBConnection("Plugins/DBConnector/MySQL_dbconfig.json")
...
// 	result.Scan(&testCase.Tc_id, &testCase.Tc_name, &testCase.Tc_desc, &testCase.Created_date, &testCase.Modified_date,
// 		&testCase.Tc_status)

// 	tc = append(tc, TestCase{testCase.Tc_id, testCase.Tc_name, testCase.Tc_desc, testCase.Created_date, testCase.Modified_date, testCase.Tc_status})
// }
